    ...
    return (
        <header className={`w-full pt-16 md:pt-29  text-center ${poppins.className}`}>
            <div className="max-w-[1200px] mx-auto px-4"> 
                <nav className="inline-flex items-center justify-center px-6 py-2 border border-[#EFF0F6] rounded-full mb-10 shadow-sm">
                ...
                <h1 className="text-[#111827] text-[40px] md:text-[64px] font-semibold leading-tight mb-5">
                    {title}
                </h1>
                <p className="max-w-[800px] mx-auto text-[#6B7280] text-[16px] md:text-[18px] font-regular leading-relaxed">
                    {description}
                </p>
