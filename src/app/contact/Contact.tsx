...
const Contact = () => {
    return (
        <>
            ...
            <section className={`max-w-[1560px] mx-auto py-10 md:py-[20px] px-4 ${poppins.className}`}>
                <div className="flex flex-col lg:flex-row gap-12">

                    {/* Sol Tərəf: Əlaqə Məlumatları */}
                    <div className="flex-1">
                        <h2 className="text-[#170F49] text-[18px] md:text-[36px] font-semibold leading-[48px] mb-4">Əlaqə Məlumatları</h2>
                        <p className="text-[#6F6C90] text-[14px] md:text-[18px] font-regular mb-10 max-w-[450px]">
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="flex items-start gap-4">
                                ...
                                <div>
                                    <h4 className="text-[#170F49] font-medium text-[16px] md:text-[18px]">Telefon</h4>
                                    <p className="text-[#6F6C90] text-[14px] md:text-[16px] font-regular ">+994 50 123 45 67</p>
                                </div>
                            </div>
                            ...
                            <div className="flex items-start gap-4">
                                ...
                                <div>
                                    <h4 className="text-[#170F49] font-medium text-[16px] md:text-[18px]">E-poçt</h4>
                                    <p className="text-[#6F6C90] text-[14px] md:text-[16px] font-regular ">info@burncode.org</p>
                                </div>
                            </div>
                            ...
                            <div className="flex items-start gap-4">
                                ...
                                <div>
                                    <h4 className="text-[#170F49] font-medium text-[16px] md:text-[18px]">Ünvan</h4>
                                    <p className="text-[#6F6C90] text-[14px] md:text-[16px] font-regular ">Bakı ş., Nizami küç. 203, AF Business House</p>
                                </div>
                            </div>
                            ...
                            <div className="flex items-start gap-4">
                                ...
                                <div>
                                    <h4 className="text-[#170F49] font-medium text-[16px] md:text-[18px]">İş Saatları</h4>
                                    <p className="text-[#6F6C90] text-[14px] md:text-[16px] font-regular ">Bazar ertəsi - Cümə: 09:00 - 18:00</p>
                                </div>
                            </div>
                        </div>

                        {/* Xəritə Bölməsi */}
                        <div className="mt-10 bg-white p-4 md:p-6 rounded-[24px]">
                            <div className="flex justify-between items-center mb-4">
                                <h4 className="text-[#170F49] font-medium text-[18px]">Xəritə görüntüsü</h4>
                    ...
                    <div className="flex-1 bg-white p-8 md:p-12 rounded-[32px] shadow-xl border border-gray-50">
                        <h3 className="text-[#170F49]  text-[18px] md:text-[30px] font-semibold mb-8">Pulsuz Konsultasiya Alın</h3>
                        ...
                        <form className="space-y-6">
                            ...
                            <div className="space-y-4">
                                ...
                                <textarea placeholder="Layihəniz haqqında qısa məlumat..." className="w-full p-4 min-h-[160px] bg-white border mt-6 border-[#EFF0F6] rounded-[12px] outline-none text-[#596063] text-[14px] md:text-[16px] font-regular focus:border-[#6344F5] transition-all resize-none"></textarea>
                            </div>
